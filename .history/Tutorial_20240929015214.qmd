...
4. Run a Test Container:
   ...
   - When you run a Docker command for the first time, Docker will check if the image is available locally on your machine. If it's not, Docker will automatically
